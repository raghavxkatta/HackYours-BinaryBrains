                        ...
                        {user ? (
                            <>
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 text-[#01FF00] border-2 border-[#01FF00] rounded-lg hover:bg-[#01FF00]/10 transition-all duration-300"
                                >
                                    Logout
                                </button>
                            </>
                            ...
                            <>
                                ...
                                <Link to="/signup" 
                                    className="px-4 py-2 bg-[#01FF00] text-black font-medium rounded-lg hover:opacity-90 transition-all duration-300">
                                    Sign Up
                                </Link>
                            </>
                        )}
